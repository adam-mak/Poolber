    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton}>
          <Image
            source={require("../assets/images/Return_to_HomePage.png")}
      ...
      <View style={styles.peopleOnTheWayContainer}>
        ...
        <View style={styles.currentLocationContainer}>
          <Image
            source={{
              uri:
                "https://www.wikihow.com/images/thumb/6/63/Get-Current-Location-on-Google-Maps-Step-2-Version-6.jpg/v4-460px-Get-Current-Location-on-Google-Maps-Step-2-Version-6.jpg",
            }}
      ...
      <View style={styles.ellipseContainer}>
        <View style={styles.ellipseBox}>
          ...
          <View style={styles.ellipseTextContainer}>
            ...
            <Text style={styles.ellipseRideApprox}>Potential Savings: $20</Text>
          </View>
        ...
        <View style={styles.ellipseBox}>
          ...
          <View style={styles.ellipseTextContainer}>
            ...
            <Text style={styles.ellipseRideApprox}>Potential Savings: $12</Text>
          </View>
          <Image source={require("../assets/images/GO.png" )} style={styles.goImage} />
        </View>
        ...
        <View style={styles.ellipseBox}>
          ...
          <View style={styles.ellipseTextContainer}>
            ...
            <Text style={styles.ellipseRideApprox}>Potential Savings: $15</Text>
          </View>
          <Image source={require("../assets/images/GO.png" )} style={styles.goImage} />
        </View>
      </View>
